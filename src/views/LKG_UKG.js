...
export default class Nursery extends Component {
	...
	render() {
		if (this.state.records.length === 0 && this.state.timeout === false) {
			return (
										...
										<CardBody>
											<ListGroup>
												...
												<ListGroupItem className="d-flex flex-column">
													...
													<ListGroupItemText className="d-flex justify-content-between">
														Phonics & Rhymes:&nbsp;<h5><Badge>{record.chapters_covered.phonics_rhymes}</Badge></h5>
													</ListGroupItemText>
													<ListGroupItemText className="d-flex justify-content-between">
														Literacy:&nbsp;<h5><Badge>{record.chapters_covered.literacy}</Badge></h5>
													</ListGroupItemText>
													<ListGroupItemText className="d-flex justify-content-between">
														Numeracy:&nbsp;<h5><Badge>{record.chapters_covered.numeracy}</Badge></h5>
													</ListGroupItemText>
													<ListGroupItemText className="d-flex justify-content-between">
														General Awareness:&nbsp;<h5><Badge>{record.chapters_covered.general_awareness}</Badge></h5>
													</ListGroupItemText>
												</ListGroupItem>
												<ListGroupItem className="d-flex flex-column">
													<ListGroupItemHeading>
			...
			return <div className="h-100 w-100 d-flex flex-column p-1">
				<Row className="p-2">
					<Col className="d-flex justify-content-center align-items-center">
						<Badge>{this.props.location.state.center}</Badge>&nbsp;
							<Badge>{this.props.location.state.standard}</Badge>&nbsp;
				...
				<div className="h-100 w-100 d-flex flex-column justify-content-center align-items-center text-white">
					<p>
						Timed out!
					</p>
					<p>
